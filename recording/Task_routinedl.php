<?php
	...
	try
	{
		...
		{
			wtask_log("[Task_routinedl] ".get_error_symbol($data["code"])." query result :".$data["code"]." ".$data["responseMessage"]."\r\n".$g_exit_symbol."send otp exit ->"."\r\n");
			return;
		}
		...
		$out = CallAPI4OptMeeting4OptMeeting("POST", $url, $data);
		//echo $out;
		...
		$data= "";
		$out = CallAPI4OptMeeting4OptMeeting("GET", $url, $data, $header);
