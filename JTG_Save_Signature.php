<?php
	...
	if ($Insurance_no 			!= '' &&
		 ...
		 strlen($Person_id) > 1)
	{
		$image = addslashes(encrypt_string_if_not_empty($g_encrypt["image"], $Signature_pic)); //SQL Injection defence!
		try
		{
			...
			if ($result = mysqli_query($link, $sql))
			{
				...
				{
					$data = result_message("false", "0x0204", "無相同身份證資料,無法更新!".$Person_id, "");
				}
			}
			else
			{
