		...
		if ($result = mysqli_query($link, $sql))
		{
			if (mysqli_num_rows($result) > 0)
			{
				while ($row = mysqli_fetch_array($result))
				{
					...
					$sql = "INSERT INTO notificationlog (insurance_no, remote_Insurance_no, person_id, role, msg, fcmresult, updatetime) VALUES ('$Insurance_no', '$Remote_insurance_no', '$Personid', 'proposer', '$msg', '$ret_fcm', NOW())";
